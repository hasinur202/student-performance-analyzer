...
@section('content')
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <button onclick="edit({{ $item }}, {{ $instituteList }})" class="btn btn-outline-primary btn-md"><i class="far fa-edit"></i></button>
                          @if($item->status == 1)
  ...
  <script>
    ...
    function changeStatus (id) {
      const uri = '/institute-management/class/toggle-status';  
      toggleStatus(uri, id)
    }
